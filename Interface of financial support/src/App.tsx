...
const tiers = [
  {
    ...
    features: ['Help cover hosting costs', 'Keep the project alive', 'Our gratitude'],
    featured: false,
  },
  {
    name: 'Monthly',
    ...
    features: ['Help cover hosting costs', 'Keep the project alive', 'Get supporter badge', 'Priority support'],
    featured: false,
  },
  {
    name: 'Sponsor',
  ...
  return (
    <div className="relative isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
      ...
      <div className="mx-auto max-w-4xl text-center">
        <h2 className="text-base/7 font-semibold text-indigo-600">Support Us</h2>
        <p className="mt-2 text-5xl font-semibold tracking-tight text-balance text-gray-900 sm:text-6xl">
          Support Our Project
        </p>
      </div>
      <p className="mx-auto mt-6 max-w-2xl text-center text-lg font-medium text-pretty text-gray-600 sm:text-xl/8">
        Your support helps us keep developing and improving the project. Choose a tier that works for you.
      </p>
      ...
      <div className="mt-16 text-center">
        <p className="text-base text-gray-600">
          Prefer to donate in a different way? Contact us at{' '}
          <a href="mailto:support@project.com" className="font-semibold text-indigo-600 hover:text-indigo-500">
            support@project.com
          </a>
        </p>
      </div>
